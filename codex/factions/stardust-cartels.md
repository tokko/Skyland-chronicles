---
id: stardust-cartels
name: The Stardust Cartels
aliases:
  - Stardust
type: faction
parent_faction: null
status: active in book 1 only; destroyed with the Skylands in book-1 ch.51
first_appearance: book-1 chapter-1
last_updated_scene: book-1 chapter-51
---

# The Stardust Cartels

## Description

The criminal drug-manufacturing and -dealing network of the Skylands. Stardust is a white-powder narcotic with strong addiction profile (book 1 ch.1 implies it's the primary illegal drug; the cartels are the entrenched powers). Production sites are large mansions converted to manufactories, staffed by **forcibly retained women who work near-naked** (no clothing in which to conceal product) for twenty Coin a week; the cartel enforces continuous work by beating any woman who pauses, even under threat. The near-naked policy is enforced on entry — workers undress at the cooking-floor doors and dress again only when leaving — and the women have no recourse: they cannot afford legal Powerstones (priced thirty Coin a week with delivery), so the manufactory wage is the only path to a household power supply, which makes the labour pool self-replenishing. Distribution runs through Undercity Skyway connections and Upper-Skylands corner sales.
...
Independent criminal organisations. No external sponsor; pure profit motive.

## Hierarchy

Each cartel has its own leadership (Markus's lover was a Mage running one site; the "Ghost" who hired Kyra in ch.2 was a senior figure of one cartel). The cartels do not unite — they compete.

## Goals

Profit. Maintain Stardust supply chain. Resist Constabulary raids.
...
| book-1 ch.1 scene-02 | Same site cleared in a multi-room trek: ~13 cartel personnel dead (2 antechamber cheap-labour, 5 of 6 cooking-rig-hall guards, 4 dispenser-room defenders including 1 off-duty Guard-plate man, 1 upper-watch guard, 1 returning back-stairs flanker who shot Anton); one cooking-rig-hall bayonet-team man escaped via the east passage to the street (presumed loose; Ford's men did not catch him); the cartel's illegal ley-line tap on the dispenser-room wall now visible and exposed; the refined-grade Stardust merchandise abandoned on the shelves; five cooking-rig-hall women left unmoved at their benches | The cartel's actual operation visible: refined-grade Stardust trade serving Surface buyers; mana stolen from the Undercity main ley-line channel via a jury-built tap; one of the city's principal mana-thieves. The site is presumed destroyed by chapter's end (manufactory burning behind Ford's courtyard executions). One escapee carries direct first-hand knowledge of who attacked the site — a continuity thread to track in scene-03/scene-04 of this chapter or later in book 1 |
...
- Stardust use is also Marissa's father Greg's casual reference frame; Stardust is the most common Skylander drug.
- The Robin Hoods rival gang (book-1 ch.1-2) targets magic-power-stealing rather than drug-dealing — they kill people for their personal magical energy reserves.
